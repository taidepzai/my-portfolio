        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-12 col-lg-6">
              <template v-for="prj in projectImage">
                <img class="portfolio-cover-img img-fluid mb-3 mg-lg-0" :src="prj" :alt="projectTitle" />
              </template>
            </div>
            ...
            <div class="col-12 col-lg-6">
              ...
              <div class="project-description mt-4">
                ...
                <template v-for="des in projectDescription">
                  <p>{{ des }}</p>
                </template>
              </div>
            </div>
